...
def part1(lines):
    ...
    print("gamma: " + gamma + " epsilon: " + epsilon + " answer: " + str(int(gamma, 2)*int(epsilon,2)))
...
def process_oxy_co2(values, pos, def_filter):
    ...
    return process_oxy_co2(list(filter(lambda value: value[pos] == filter_val, values)), pos + 1, def_filter)
...
def part2(lines):
    ...
    print("oxy: " + str(oxy) + " co2: " + co2 +" answer: " + str(int(oxy, 2)*int(co2,2)))
